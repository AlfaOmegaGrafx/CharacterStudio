 ...
 *   set ANIM_SMOKE_URL=https://<SURFACE_LAN_IP>:3000 && npm run test:anim-smoke
 *
 * Manual browser QA: open the SAME origin as your working dev tab, append ?animSmoke=1
 * (e.g. https://<SURFACE_LAN_IP>:3000/?animSmoke=1 — not http://localhost if Vite serves HTTPS on LAN).
 */

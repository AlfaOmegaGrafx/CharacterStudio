...
SURFACE_ROOT="${SURFACE_ROOT:-C:/Users/<SURFACE_USER>/Documents/GitHub/CharacterStudio}"
...
ssh "$SURFACE_SSH" "powershell -NoProfile -Command \"\$env:Path = '<SURFACE_LOCAL_BIN>;' + \$env:Path; cd 'C:\\Users\\alfao\\Documents\\GitHub\\CharacterStudio'; sessionmem sync\""

 ...
 * Galaxy XR / Surface LAN reaches <SURFACE_LAN_IP> but not <DGX_LAN_IP> (router client isolation).
...
const TARGET = new URL(process.env.MSF_SPARK_URL || 'https://<DGX_LAN_IP>:8443');

...
const MSF_URL = (process.env.VITE_MSF_PUBLIC_URL || 'https://<SURFACE_LAN_IP>:8453').replace(/\/$/, '');
const XR_URL = (process.env.VITE_XR_HUB_URL || 'https://<SURFACE_LAN_IP>:8443').replace(/\/$/, '');

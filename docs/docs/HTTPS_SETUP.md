...
3. **Generate certificates:**
   ...
   # Example: <SURFACE_LAN_IP> (Surface on LAN — use `ipconfig` / `hostname -I`, not the DGX unless Vite runs there)
   ```
...
2. Find your **dev workstation** LAN IP (Surface: `ipconfig`; e.g. `<SURFACE_LAN_IP>`)

...
- **`webcamAvatarDriver.js`**: Webcam-based face tracking for avatar control (Kalidokit + MediaPipe). Disabled automatically when WebXR is active. See [Webcam Avatar Control](../../docs/docs/WEBCAM_AVATAR_CONTROL.md).

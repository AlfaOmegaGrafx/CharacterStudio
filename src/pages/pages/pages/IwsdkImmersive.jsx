  ...
  return (
    <div className="iwsdk-immersive-page">
        ...
        >
          ...
          {phase === 'ready' &&
            (worldLabel
              ? `World: ${worldLabel} — `
              : '') +
            'Galaxy XR: far = aim + trigger (ray). Near = walk up + grip squeeze. Exit: Menu/B, red panel, or Escape'}
      ...
      <p className="iwsdk-immersive-hint">
        ...
        {' '}
        <strong>VRM face tracking</strong> runs on the main app at <code>/</code>, not this IWSDK lab.
      </p>
    </div>
  );
}
